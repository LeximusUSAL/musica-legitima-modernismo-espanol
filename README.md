...
Este repositorio contiene el código, datos y documentación de la investigación **"Construir la música legítima: estrategias léxicas y poder simbólico en la prensa del modernismo español (El Sol, España y Ondas, 1915-1935)"**. Los datos de autoría del repositorio se han anonimizado porque el texto se encuentra actualmente en revisión por pares. 
